      ...
      <InputGroup label="场景">
        <EntitySelector
          ...
          onChange={(eraId, entity) => {
            ...
            if (entity?.name != null) {
              updates.eraName = String(entity.name);
            } else {
              updates.eraName = null;
            }
            onUpdate(updates);
          }}
        />
      ...
      <InputGroup label="角色">
        <EntitySelector
          ...
          onChange={(characterId, entity) => {
            ...
            if (entity?.name != null) {
              updates.characterName = String(entity.name);
            } else {
      ...
      <InputGroup label="事件">
        <EntitySelector
          ...
          onChange={(eventId, entity) => {
            ...
            if (entity?.name != null) {
              updates.eventName = String(entity.name);
            } else {
              updates.eventName = null;
            }
            onUpdate(updates);
          }}
        />
      ...
      <InputGroup label="物品">
        <EntitySelector
          ...
          onChange={(itemId, entity) => {
            ...
            if (entity?.name != null) {
              updates.itemName = String(entity.name);
            } else {
