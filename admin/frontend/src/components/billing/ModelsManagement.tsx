...
export const ModelsManagement: React.FC<ModelsManagementProps> = ({
  ...
  const loadProviders = async () => {
    ...
    try {
      ...
      setProviders([
        { id: 1, name: 'openai', displayName: 'OpenAI', enabled: true, createdAt: now, updatedAt: now },
        { id: 2, name: 'dashscope', displayName: 'DashScope (通义千问)', enabled: true, createdAt: now, updatedAt: now },
        { id: 3, name: 'gemini', displayName: 'Google Gemini', enabled: true, createdAt: now, updatedAt: now },
        { id: 4, name: 'doubao', displayName: 'Doubao (豆包)', enabled: true, createdAt: now, updatedAt: now },
      ] as AIProvider[]);
    }
  };
  ...
  const handleCreateModel = () => {
    ...
    setEditingModel({ id: undefined, ...modelFormData } as unknown as AIModelConfig);
  };
