...
export const promptApi = {
  ...
  async getTemplates(
    ...
    return request<PromptTemplateListResponse>(
      `/prompts/templates?${queryParams.toString()}`,
      {
        method: 'GET',
        headers: {
  ...
  async renderTemplate(renderRequest: PromptRenderRequest, token: string): Promise<PromptRenderResponse> {
    return request<PromptRenderResponse>(
      `/prompts/templates/${renderRequest.templateId}/render`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  async generatePrompt(
    ...
    return request<PromptGenerateResponse>(
      `/prompts/templates/${generateRequest.templateId}/generate`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
