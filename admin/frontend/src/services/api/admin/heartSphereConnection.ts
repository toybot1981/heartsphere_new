...
export const adminHeartSphereConnectionApi = {
  ...
  getShareConfigs: async (
    ...
    const pageData = await request<{
      ...
      `/heartsphere-connection/share-configs?${queryParams.toString()}`,
      {
        headers: {
  ...
  getShareConfigDetail: async (id: number, token: string): Promise<HeartSphereShareConfigDTO> => {
    ...
    return request<HeartSphereShareConfigDTO>(
      `/heartsphere-connection/share-configs/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  disableShareConfig: async (id: number, reason?: string, token?: string): Promise<{ success: boolean }> => {
    const response = await request<{ success: boolean; data?: any; message?: string }>(
      `/heartsphere-connection/share-configs/${id}/disable`,
      {
        method: 'POST',
  ...
  enableShareConfig: async (id: number, token: string): Promise<{ success: boolean }> => {
    const response = await request<{ success: boolean; data?: any; message?: string }>(
      `/heartsphere-connection/share-configs/${id}/enable`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  pauseShareConfig: (id: number, reason?: string, token?: string): Promise<{ success: boolean }> => {
    return request<{ success: boolean }>(
      `/heartsphere-connection/share-configs/${id}/pause`,
      {
        method: 'POST',
        body: JSON.stringify({ reason }),
        headers: {
  ...
  batchDisableShareConfigs: (
    ...
    return request<{ success: boolean }>(
      '/heartsphere-connection/share-configs/batch-disable',
      {
        method: 'POST',
  ...
  batchDeleteShareConfigs: (
    ...
    return request<{ success: boolean }>(
      '/heartsphere-connection/share-configs/batch-delete',
      {
        method: 'POST',
        body: JSON.stringify({ configIds, reason }),
        headers: {
  ...
  getConnectionRequests: async (
    ...
    const pageData = await request<{
      ...
      `/heartsphere-connection/connection-requests?${queryParams.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  getConnectionRequestDetail: async (id: number, token: string): Promise<ConnectionRequestDTO> => {
    ...
    return request<ConnectionRequestDTO>(
      `/heartsphere-connection/connection-requests/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  approveConnectionRequest: (
    ...
    return request<{ success: boolean }>(
      `/heartsphere-connection/connection-requests/${id}/approve`,
      {
        method: 'POST',
  ...
  rejectConnectionRequest: (
    ...
    return request<{ success: boolean }>(
      `/heartsphere-connection/connection-requests/${id}/reject`,
      {
        method: 'POST',
        body: JSON.stringify({ reason }),
        headers: {
  ...
  batchApproveConnectionRequests: (
    ...
    return request<{ success: boolean }>(
      '/heartsphere-connection/connection-requests/batch-approve',
      {
        method: 'POST',
  ...
  batchRejectConnectionRequests: (
    ...
    return request<{ success: boolean }>(
      '/heartsphere-connection/connection-requests/batch-reject',
      {
        method: 'POST',
  ...
  getAccessRecords: async (
    ...
    const pageData = await request<{
      ...
      `/heartsphere-connection/access-records?${queryParams.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  getAccessRecordDetail: async (id: number, token: string): Promise<AccessRecordDTO> => {
    ...
    return request<AccessRecordDTO>(
      `/heartsphere-connection/access-records/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  exportAccessRecords: (
    ...
    return request<AccessRecordDTO[]>(
      `/heartsphere-connection/access-records/export?${queryParams.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  getWarmMessages: async (
    ...
    const pageData = await request<{
      ...
      `/heartsphere-connection/warm-messages?${queryParams.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  getWarmMessageDetail: async (id: number, token: string): Promise<WarmMessageDTO> => {
    ...
    return request<WarmMessageDTO>(
      `/heartsphere-connection/warm-messages/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  reviewWarmMessage: (
    ...
    return request<{ success: boolean }>(
      `/heartsphere-connection/warm-messages/${id}/review`,
      {
        method: 'POST',
  ...
  batchReviewWarmMessages: (
    ...
    return request<{ success: boolean }>(
      '/heartsphere-connection/warm-messages/batch-review',
      {
        method: 'POST',
  ...
  batchDeleteWarmMessages: (
    ...
    return request<{ success: boolean }>(
      '/heartsphere-connection/warm-messages/batch-delete',
      {
        method: 'POST',
  ...
  getStatistics: async (
    ...
    return request<HeartSphereConnectionStatisticsDTO>(
      `/heartsphere-connection/statistics?${queryParams.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  getTrendData: (
    ...
    return request<Record<string, any>>(
      `/heartsphere-connection/trend-data?${queryParams.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  getExceptionRecords: async (
    ...
    const pageData = await request<{
      ...
      `/heartsphere-connection/exceptions?${queryParams.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  handleException: (
    ...
    return request<{ success: boolean }>(
      `/heartsphere-connection/exceptions/${id}/handle`,
      {
        method: 'POST',
  ...
  getComplaints: async (
    ...
    const pageData = await request<{
      ...
      `/heartsphere-connection/complaints?${queryParams.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  handleComplaint: (
    ...
    return request<{ success: boolean }>(
      `/heartsphere-connection/complaints/${id}/handle`,
      {
        method: 'POST',
        body: JSON.stringify({ handleResult, adminNote }),
        headers: {
