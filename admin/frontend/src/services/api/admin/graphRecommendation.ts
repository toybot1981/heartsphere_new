...
export const adminGraphRecommendationApi = {
  ...
  recommendEntities: (
    ...
    return request<RecommendationResponse<EntityRecommendation>>('/graph/recommendations/entities', {
      method: 'POST',
      body: JSON.stringify({
        entityType,
        existingEntityIds,
  ...
  autoDetectRelations: (
    ...
    return request<RecommendationResponse<RelationRecommendation>>('/graph/recommendations/relations', {
      method: 'POST',
      body: JSON.stringify({
        entities,
        context,
  ...
  suggestOptimizations: (
    ...
    return request<RecommendationResponse<OptimizationSuggestion>>('/graph/recommendations/optimizations', {
      method: 'POST',
      body: JSON.stringify({
        nodes,
        edges,
