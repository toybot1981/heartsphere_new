...
public class EmailService {
    ...
    public void updateMailSender() {
        ...
        // 从系统配置获取邮件服务器配置
        String host = systemConfigService.getEmailHost();
        String portStr = systemConfigService.getEmailPort();
        String username = systemConfigService.getEmailUsername();
        String password = systemConfigService.getEmailPassword();
        String from = systemConfigService.getEmailFrom();
