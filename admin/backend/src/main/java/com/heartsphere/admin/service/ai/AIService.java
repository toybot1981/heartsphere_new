package com.heartsphere.admin.service.ai;

import com.heartsphere.admin.dto.ai.*;
import com.heartsphere.admin.util.StreamResponseHandler;
...
public interface AIService {
    ...
    // TODO: 迁移 UserAIConfig 实体后再启用这些方法
    // /**
    //  * 获取用户AI配置
    //  * @param userId 用户ID
    //  * @return 用户AI配置
