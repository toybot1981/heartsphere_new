...
// TODO: 迁移这些实体和 DTO 到 admin 模块或使用共享模块
...
// import com.heartsphere.admin.repository.ScriptRepository;
...
public class AdminSystemDataController {
    ...
    // TODO: 迁移 EmailService 到 admin 模块或使用共享模块
    // @Autowired
    // private com.heartsphere.service.EmailService emailService;

    // TODO: 迁移这些 Repository 到 admin 模块
    // @Autowired
    ...
    public ResponseEntity<Map<String, Object>> getInviteCodeRequired(
      ...
      public ResponseEntity<Map<String, Object>> setEmailConfig(
          ...
          // TODO: 更新邮件服务配置 - EmailService 需要迁移到 admin 模块或使用共享模块
          // try {
      ...
      // TODO: 这些方法依赖于旧的实体（Script, World, Era, User）和 Repository
      // 需要迁移这些实体到 admin 模块或使用共享模块后才能启用
      /*
