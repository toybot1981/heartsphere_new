 ...
 * 显示在访问他人心域时的顶部标识
 */
export const ExperienceModeBanner: React.FC<ExperienceModeBannerProps> = ({
  heartSphereName,
  ownerName,
  onCollapse,
  onLeave,
          ...
          <div className="flex items-start gap-4 flex-1">
            ...
            <div className="flex-1">
              <div className="text-gray-800 font-semibold mb-1">
                正在体验 <span className="text-blue-600">{heartSphereName}</span> 的心域
                {ownerName && (
