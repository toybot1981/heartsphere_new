  ...
  return (
    <MobileErrorBoundary>
      <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-sm flex flex-col">
        {/* 头部栏 */}
        <div className="flex items-center justify-between p-4 pt-[calc(1rem+env(safe-area-inset-top))] bg-gradient-to-b from-black/95 via-black/90 to-black/60 backdrop-blur-md border-b border-white/10">
          <h2 className="text-xl font-bold text-white">心域连接</h2>
                ...
                <div className="mb-3">
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="搜索角色名称..."
                      className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 text-base min-h-[44px]"
                    />
                    {searchQuery && (
                      <button
                  ...
                  <div className="space-y-3">
                    {filteredCharacters.map((character) => (
                      <div
                        ...
                        className="p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-purple-500/50 active:bg-gray-700/50 transition-all cursor-pointer touch-manipulation"
                        role="button"
                        tabIndex={0}
                        onKeyPress={(e) => {
