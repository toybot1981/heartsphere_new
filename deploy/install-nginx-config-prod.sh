...
echo -e "  多项目路径路由:"
echo -e "    - main (PC): ${BLUE}http://heartsphere.cn/${NC}"
echo -e "    - main (Mobile): ${BLUE}http://heartsphere.cn/mobile.html${NC}"
echo -e "    - admin: ${BLUE}http://heartsphere.cn/admin.html${NC}"
echo -e "    - edu: ${BLUE}http://heartsphere.cn/edu.html${NC}"
echo -e "    - mentis: ${BLUE}http://heartsphere.cn/mentis${NC}"
echo -e "  前端路径:"
echo -e "    - main: ${BLUE}/opt/heartsphere/main/frontend${NC}"
echo -e "    - admin: ${BLUE}/opt/heartsphere/admin/frontend${NC}"
echo -e "    - edu: ${BLUE}/opt/heartsphere/edu/frontend${NC}"
echo -e "    - mentis: ${BLUE}/opt/heartsphere/mentis/frontend${NC}"
echo -e "  后端API代理:"
