...
echo -e "  前端路径: ${BLUE}/Users/admin/Workspace/heartsphere_new/frontend/dist${NC}"
echo -e "  后端API: ${BLUE}http://localhost:8081${NC}"
echo -e "  图片路径: ${BLUE}/Users/admin/Workspace/heartsphere_new/backend/uploads/images/${NC}"
