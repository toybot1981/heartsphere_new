...
### 3.1 应用入口
```
aistudio/src/main/java/com/heartsphere/aistudio/
└── AiAgentApplication.java            # AI Agent服务主类
```

### 3.2 Agent核心（agent/）
```
aistudio/src/main/java/com/heartsphere/aistudio/agent/
├── Agent.java                         # Agent核心类
...
### 3.3 模型适配器（adapter/）
```
aistudio/src/main/java/com/heartsphere/aistudio/adapter/
...
### 3.4 工作流引擎（graph/）
```
aistudio/src/main/java/com/heartsphere/aistudio/graph/
└── WorkflowBuilder.java               # 工作流构建器
```

### 3.5 工具集成（tool/）
```
aistudio/src/main/java/com/heartsphere/aistudio/tool/
├── Tool.java                          # 工具接口
...
### 3.6 工作流定义（workflow/）
```
aistudio/src/main/java/com/heartsphere/aistudio/workflow/
└── [工作流定义文件]                    # 工作流定义类
```

### 3.7 控制器（controller/）
```
aistudio/src/main/java/com/heartsphere/aistudio/controller/
...
### 3.8 服务（service/）
```
aistudio/src/main/java/com/heartsphere/aistudio/service/
└── AgentService.java                  # Agent服务
```

### 3.9 配置（config/）
```
aistudio/src/main/java/com/heartsphere/aistudio/config/
└── AiConfig.java                      # AI配置类
```
...
### 3.11 MCP相关（mcp/）
```
aistudio/src/main/java/com/heartsphere/aistudio/mcp/
└── [MCP相关文件]
```
...
### 5.1 前端源代码路径
- 根目录：`/main/frontend/`
- 源代码目录：`/main/frontend/src/` 或 `/main/frontend/`（部分文件在根目录）
- 组件目录：`/main/frontend/components/`
- 服务目录：`/main/frontend/services/`
- 工具目录：`/main/frontend/utils/`
- 移动端目录：`/main/frontend/mobile/`

### 5.2 后端源代码路径
- 根目录：`/main/backend/`
- 源代码目录：`/main/backend/src/main/java/com/heartsphere/`
- 资源目录：`/main/backend/src/main/resources/`

### 5.3 AI Agent源代码路径
- 根目录：`/aistudio/`
- 源代码目录：`/aistudio/src/main/java/com/heartsphere/aistudio/`
- 资源目录：`/aistudio/src/main/resources/`
