...
import { mockTeachers } from '../../types/mock';
        ...
        <Card className="mb-6">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold mb-1">{currentTeacher.username}</h2>
              <p className="text-gray-600 mb-2">
                {currentTeacher.school} · {currentTeacher.subject}老师
              </p>
              <p className="text-sm text-gray-500">
                注册时间：{new Date(currentTeacher.createdAt).toLocaleDateString('zh-CN')}
              </p>
            </div>
