-- 心小暖技能绑定 - 第一部分（技能1-2）
-- 执行方法：mysql -h 127.0.0.1 -u root -p123456 heartsphere --default-character-set=utf8mb4 < V20250106_17__bind_emotion_companion_skills_part1.sql
-- 
-- 说明：本文件绑定心小暖的前2个技能
...
WHERE character_id = @character_id
    AND skill_id IN ('emotion_recognition_expression', 'emotion_regulation_techniques');
...
WHERE csb.character_id = @character_id
    AND csb.skill_id IN ('emotion_recognition_expression', 'emotion_regulation_techniques')
