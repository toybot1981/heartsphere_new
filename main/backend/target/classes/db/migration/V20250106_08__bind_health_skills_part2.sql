-- 康小健技能绑定 - 第二部分（技能3-4）
-- 执行方法：mysql -h 127.0.0.1 -u root -p123456 heartsphere --default-character-set=utf8mb4 < V20250106_08__bind_health_skills_part2.sql
-- 
-- 说明：本文件绑定康小健的第3-4个技能
...
WHERE character_id = @character_id
    AND skill_id IN ('exercise_plan_creation', 'sleep_quality_improvement');
...
WHERE csb.character_id = @character_id
    AND csb.skill_id IN ('exercise_plan_creation', 'sleep_quality_improvement')
