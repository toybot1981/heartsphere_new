-- 心小暖技能绑定 - 第二部分（技能3-4）
-- 执行方法：mysql -h 127.0.0.1 -u root -p123456 heartsphere --default-character-set=utf8mb4 < V20250106_18__bind_emotion_companion_skills_part2.sql
-- 
-- 说明：本文件绑定心小暖的第3-4个技能
...
WHERE character_id = @character_id
    AND skill_id IN ('active_listening_empathy', 'mindfulness_practice_guidance');
...
WHERE csb.character_id = @character_id
    AND csb.skill_id IN ('active_listening_empathy', 'mindfulness_practice_guidance')
