...
import com.heartsphere.entity.EntityRelation;
import com.heartsphere.repository.EntityRelationRepository;
...
public class EntityRelationService {
    ...
    public EntityRelation createRelation(
        ...
        if (userId != null) {
            relation.setUser(new com.heartsphere.entity.User());
