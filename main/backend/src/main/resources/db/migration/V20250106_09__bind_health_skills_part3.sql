-- 康小健技能绑定 - 第三部分（技能5-6）
-- 执行方法：mysql -h 127.0.0.1 -u root -p123456 heartsphere --default-character-set=utf8mb4 < V20250106_09__bind_health_skills_part3.sql
-- 
-- 说明：本文件绑定康小健的第5-6个技能
...
WHERE character_id = @character_id
    AND skill_id IN ('stress_management', 'health_habit_formation');
...
WHERE csb.character_id = @character_id
    AND csb.skill_id IN ('stress_management', 'health_habit_formation')
