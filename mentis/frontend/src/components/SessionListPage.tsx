...
import { MentisApiService, Session } from '../services/mentisApi';
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 2 }}>
          {sessions.map((session) => (
            <Card key={session.sessionId}>
              ...
              <CardActions>
              <Button size="small" component="a" href={`/mentis/session/${session.sessionId}`}>
                打开
              </Button>
                <IconButton
                  size="small"
