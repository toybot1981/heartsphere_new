...
public class LLMIntentRecognizer implements IntentRecognizer {
    ...
    @Override
    public IntentRecognitionResult recognize(String userMessage, String sessionId) {
     ...
     * 解析 LLM 响应
     */
    private IntentRecognitionResult parseResponse(String responseContent) {
        try {
     ...
     * 创建默认识别结果
     */
    private IntentRecognitionResult createDefaultResult(String userMessage) {
        IntentRecognitionResult result = new IntentRecognitionResult();
